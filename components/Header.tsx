...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white shadow-sm border-b border-gray-200">
      ...
      <div className="bg-gray-100 py-1 xs:py-2 text-xs hidden sm:block">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link href="/stores" className="hover:text-primary">Magazine</Link>
            <Link href="/help" className="hover:text-primary">Ajutor</Link>
          </div>
        </div>
      </div>
      ...
      <div className="py-2 xs:py-3 sm:py-4">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 flex items-center justify-between gap-2 xs:gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-1 xs:gap-2 lg:gap-3">
            {/* Cart with badge */}
            <Link href="/cart" className="relative group p-1 xs:p-1.5 sm:p-2 hover:bg-gray-100 rounded-lg transition-colors">
              <ShoppingCart className="w-5 h-5 xs:w-6 xs:h-6 lg:w-7 lg:h-7 text-gray-700 group-hover:text-primary transition" />
              <Badge className="absolute -top-0.5 -right-0.5 xs:-top-1 xs:-right-1 h-4 w-4 xs:h-5 xs:w-5 rounded-full p-0 flex items-center justify-center text-xs bg-red-500 hover:bg-red-600">
                3
              </Badge>
            ...
            {/* Account */}
            <Link href="/account" className="group p-1 xs:p-1.5 sm:p-2 hover:bg-gray-100 rounded-lg transition-colors">
              <User className="w-5 h-5 xs:w-6 xs:h-6 lg:w-7 lg:h-7 text-gray-700 group-hover:text-primary transition" />
      ...
      <div className="bg-gray-50 border-t border-gray-200 hidden sm:block">
        <div className="max-w-7xl mx-auto px-4">
          <nav className="flex items-center gap-4 md:gap-6 lg:gap-8 py-3 text-xs sm:text-sm overflow-x-auto">
            <Link href="/categories/materiale-constructii" className="whitespace-nowrap hover:text-primary font-medium">
              <span className="hidden lg:inline">Materiale construcții</span>
              <span className="lg:hidden">Materiale</span>
            </Link>
            <Link href="/categories/unelte" className="whitespace-nowrap hover:text-primary font-medium">
              Unelte
            </Link>
            <Link href="/categories/gradina" className="whitespace-nowrap hover:text-primary font-medium">
              Grădină
            </Link>
            <Link href="/categories/instalatii" className="whitespace-nowrap hover:text-primary font-medium">
              <span className="hidden md:inline">Instalații</span>
              <span className="md:hidden">Instal.</span>
            </Link>
            <Link href="/categories/decoratiuni" className="whitespace-nowrap hover:text-primary font-medium">
              <span className="hidden md:inline">Decorațiuni</span>
              <span className="md:hidden">Decor</span>
            </Link>
            <Link href="/categories/mobilier" className="whitespace-nowrap hover:text-primary font-medium">
              Mobilier
            </Link>
            <Link href="/offers" className="whitespace-nowrap text-red-600 hover:text-red-700 font-semibold">
